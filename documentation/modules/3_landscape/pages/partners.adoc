...
NOTE: Matt Bader from Veeam was recently a guest on the OpenShift Commons, Validated Patterns SIG (Special Interest Group) call and did an awesome presentation and demo of Veeam with Validated Patterns. Feel free to check out link:https://youtu.be/mJxoRFoOmDo?si=UAqouHqHj8f6uYMC[on YouTube]
