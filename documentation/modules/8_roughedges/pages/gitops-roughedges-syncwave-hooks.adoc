...
----
include::example$todo/postgres-deployment.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/postgres-service.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/postgres-create-table.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/todo-deployment.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/todo-service.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/todo-route.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo/todo-insert-data.yaml[]
----
...
[source,yaml,subs="+macros,attributes+"]
----
include::example$todo-application.yaml[]
----
