...
** xref:landscape.adoc#partners[Working with Partners]
*** xref:landscape.adoc#intel[Intel]
**** xref:landscape.adoc#intel-mcgo[Intel MultiCloud GitOps]
**** xref:landscape.adoc#intel-md[Intel Medical Diagnosis]
*** xref:landscape.adoc[Portworx]
**** xref:landscape.adoc#pwx-mcgo[Portworx]
*** xref:landscape.adoc[Cisco]
**** xref:landscape.adoc#cisco-pwx-mcgo[Cisco]
*** xref:landscape.adoc[Veeam/Kasten]
*** xref:landscape.adoc#veeam-mcgo[Veeam/Kasten]
