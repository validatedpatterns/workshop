...
Operator creation screengrab

Operator URL parsing

Get the operators via the cli


=== Introducing new helm charts

Directories don't matter - it's just convention
...
Copy and paste is your best start with MCG.
...
[source,yaml]
====
# Override values defined at the `clusterGroup` level
letsencrypt:
  region: ''
...
[source,yaml]
====
# Best practice lines up naming here
global:
====
